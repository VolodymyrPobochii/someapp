...
data class UserData(
    ...
    @SerializedName("last_modified_date") val lastModified: Date? = null,
    @SerializedName("last_access_date") val lastAccess: Date? = null,
    @SerializedName("creation_date") val created: Date? = null,
